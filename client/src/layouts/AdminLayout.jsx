...
import { LayoutDashboard, Users, UserCog, Calendar, Ticket, FileText, Images, MailOpen, BarChart3, MessageCircle, Bell, Settings, LogOut, RefreshCw, Receipt, Tag, Layers, Handshake, Heart, Menu, X, ScanLine, UserCheck } from 'lucide-react';
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/admin/guest-list', label: 'Guest List', icon: UserCheck },
